...
@SpringBootTest(properties = {
        ...
        "voltflow.kafka.partitions=1",
        "voltflow.kafka.replicas=1",
...
@EmbeddedKafka(
        ...
        partitions = 1,
        topics = {
                "voltflow.asset-registration",
                "voltflow.asset-registration.dlt",
                "voltflow.telemetry"
        },
        brokerProperties = {
...
class KafkaContractIntegrationTest {
    ...
    void consumesRegistrationAndProducesTelemetryOverRealKafkaWireContract() throws Exception {
        ...
        try (Consumer<String, String> telemetryConsumer = new DefaultKafkaConsumerFactory<>(
            ...
            telemetryConsumer.subscribe(List.of("voltflow.telemetry"));
            ...
            ConsumerRecord<String, String> record = KafkaTestUtils.getSingleRecord(
                    telemetryConsumer, "voltflow.telemetry", Duration.ofSeconds(5)
            );
