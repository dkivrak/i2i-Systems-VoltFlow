...
@Validated
@ConfigurationProperties(prefix = "voltflow.kafka")
public class KafkaTopicProperties {

    @NotBlank
    private String assetRegistrationTopic = "voltflow.asset-registration";

    @NotBlank
    private String telemetryTopic = "voltflow.telemetry";

    @NotBlank
    private String registrationDltTopic = "voltflow.asset-registration.dlt";
