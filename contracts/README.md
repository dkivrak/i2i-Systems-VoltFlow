...
This directory is the language-neutral contract source for VoltFlow HTTP payloads
...
| --- | --- | --- | --- |
| `voltflow.asset-registration` | VoltFlow Core | Telemetry Simulator | `asset-registration-event.schema.json` |
| `voltflow.telemetry` | Telemetry Simulator | VoltFlow Core | `telemetry-event.schema.json` |
...
`voltflow.asset-registration.dlt` after its configured retries.
