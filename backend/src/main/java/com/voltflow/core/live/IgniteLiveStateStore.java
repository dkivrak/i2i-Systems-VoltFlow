...
@Component
@ConditionalOnProperty(prefix = "voltflow.ignite", name = "enabled", havingValue = "true")
public class IgniteLiveStateStore implements LiveStateStore {
    ...
    public IgniteLiveStateStore(VoltFlowProperties properties, ObjectMapper objectMapper) {
