...
@Validated
@ConfigurationProperties(prefix = "voltflow")
public class VoltFlowProperties {
    ...
    public static class Kafka {
        ...
        @NotBlank private String assetRegistrationTopic = "voltflow.asset-registration";
        @NotBlank private String telemetryTopic = "voltflow.telemetry";
        @NotBlank private String telemetryDltTopic = "voltflow.telemetry.dlt";
    ...
    public static class Ignite {
        ...
        @NotBlank private String cacheName = "voltflow-live-state";
